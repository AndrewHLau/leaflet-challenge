...
function createFeatures(earthquakeData) {
    ...
    function style(geoJsonFeature) {
        ...
        return {
            ...
            radius:geoJsonFeature.properties.mag*4
        }
    }
    // Create a GeoJSON layer containing the features array on the earthquakeData object //GeoJson creates the markers and the layer groups
